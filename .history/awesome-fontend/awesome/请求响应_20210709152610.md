...
|-----------------------|:-------------------:|:------------------:|:--------------------:|:------------------------:|:------------------:|:----------------------:|
| HTTP/2 support        | ✔️ | ❌ | :x:                  | :x:                      | :x:                | :heavy_check_mark:\*\* |
| Browser support       | ❌ | :x:                | :heavy_check_mark:\* | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Promise API           | ✔️ | :heavy_check_mark: | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Stream API            | ✔️ | :heavy_check_mark: | Node.js only         | :x:                      | ✔️ | :heavy_check_mark:     |
| Pagination API        | ✔️ | :x:                | :x:                  | :x:                      | ✔️ | :x:                    |
| Request cancelation   | ✔️ | :x:                | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| RFC compliant caching | ✔️ | :x:                | :x:                  | :x:                      | ✔️ | :x:                    |
| Cookies (out-of-box)  | ✔️ | :heavy_check_mark: | :x:                  | :x:                      | ✔️ | :x:                    |
| Follows redirects     | ✔️ | :heavy_check_mark: | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Retries on failure    | ✔️ | :x:                | :x:                  | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Progress events       | ✔️ | :x:                | :x:                  | :heavy_check_mark:\*\*\* | Browser only       | :heavy_check_mark:     |
