...
|-----------------------|:-------------------:|:------------------:|:--------------------:|:------------------------:|:------------------:|:----------------------:|
| HTTP/2 support        | ✔️ | ❌ | ❌ | :x:                      | :x:                | :heavy_check_mark:\*\* |
...
| Pagination API        | ✔️ | ❌ | ❌ | :x:                      | ✔️ | :x:                    |
| Request cancelation   | ✔️ | ❌ | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| RFC compliant caching | ✔️ | ❌ | ❌ | :x:                      | ✔️ | :x:                    |
| Cookies (out-of-box)  | ✔️ | ✔️ | ❌ | :x:                      | ✔️ | :x:                    |
| Follows redirects     | ✔️ | ✔️ | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Retries on failure    | ✔️ | ❌ | ❌ | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Progress events       | ✔️ | ❌ | ❌ | :heavy_check_mark:\*\*\* | Browser only       | :heavy_check_mark:     |
