...
| Browser support       | ❌ | ❌ | :heavy_check_mark:\* | :heavy_check_mark:       | ✔️ | ✔️ |
...
| Pagination API        | ✔️ | ❌ | :x:                  | :x:                      | ✔️ | :x:                    |
| Request cancelation   | ✔️ | ❌ | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| RFC compliant caching | ✔️ | ❌ | :x:                  | :x:                      | ✔️ | :x:                    |
| Cookies (out-of-box)  | ✔️ | ✔️ | :x:                  | :x:                      | ✔️ | :x:                    |
| Follows redirects     | ✔️ | ✔️ | :heavy_check_mark:   | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Retries on failure    | ✔️ | ❌ | :x:                  | :heavy_check_mark:       | ✔️ | :heavy_check_mark:     |
| Progress events       | ✔️ | ❌ | :x:                  | :heavy_check_mark:\*\*\* | Browser only       | :heavy_check_mark:     |
